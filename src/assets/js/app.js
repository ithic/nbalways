...
const datasets = {
    'en': 'ck9vtcwy20dtj2lk4etqjm4rd',
    'fr': 'ckaoa5dhb261w22rst74fvdzz'
};

map.addControl(new mapboxgl.NavigationControl());
map.on('load', () => {
    fetch(`https://api.mapbox.com/datasets/v1/jrrankin/${datasets[document.documentElement.lang.toLowerCase()]}/features?access_token=pk.eyJ1IjoianJyYW5raW4iLCJhIjoiY2s5dnQ5bjVuMDJzMzNtcnI1dnJuOTlocyJ9.SQv9UqQvK05yKgK9Xgxxrw&limit=200`)
    .then((response) => {
