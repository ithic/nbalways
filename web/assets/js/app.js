...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#newsletter-form').validate({
  submitHandler: function submitHandler(form) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function success(response) {
        console.log('success!');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#response').html(response.message);
      }
    });
  }
});
...
module.exports = __webpack_require__(/*! /Users/rob/Developer/nbalways/src/assets/js/app.js */"./src/assets/js/app.js");
